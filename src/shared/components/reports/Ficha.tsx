...
const FichaMembro: React.FC<MembroPDFProps> = ({ data }) => (
  <Document>
    <Page style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
            ...
            <Text style={styles.label}>Naturalidade: <Text style={styles.value}>{data.naturalidade}</Text></Text>
        </View>
        <View style={styles.row}>
            <Text style={styles.label}>Município: <Text style={styles.value}>{data.municipio}</Text></Text>
            <Text style={styles.label}>Bairro: <Text style={styles.value}>{data.bairro}</Text></Text>    
        </View>
        <View style={styles.row}>
            <Text style={styles.label}>BI: <Text style={styles.value}>{data.bi}</Text></Text>
            <Text style={styles.label}>Cartão de Militante: <Text style={styles.value}>{data.cartao_militante}</Text></Text>
        </View>
        <View style={styles.row}>
            <Text style={styles.label}>Cartão Eleitoral: <Text style={styles.value}>{data.cartao_eleitoral}</Text></Text>
            <Text style={styles.label}>Data de Ingresso: 
                <Text style={styles.value}>
                {new Date(data.data_ingresso).toLocaleDateString('pt-PT')}
                </Text>
            </Text>
        </View>
        <View style={styles.row}>
            <Text style={styles.label}>CAS: <Text style={styles.value}>{data.cas}</Text></Text>
            <Text style={styles.label}>CAP: <Text style={styles.value}>{data.cap}</Text></Text>            
        </View>
        <View style={styles.row}>
            <Text style={styles.label}>Profissão: <Text style={styles.value}>{data.profissao}</Text></Text>
            <Text style={styles.label}>Habilitação: <Text style={styles.value}>{data.habilitacao}</Text></Text>
        </View>
        <View style={styles.row}>
            <Text style={styles.label}>Ocupação: <Text style={styles.value}>{data.ocupacao}</Text></Text>
            <Text style={styles.label}>Função: <Text style={styles.value}>{data.funcao}</Text></Text>
        </View>
        <View style={styles.row}>
            <Text style={styles.label}>Telefone: <Text style={styles.value}>{data.telefone}</Text></Text>
